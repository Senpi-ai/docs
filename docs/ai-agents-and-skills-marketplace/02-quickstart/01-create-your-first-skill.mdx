...
To develop an AI Agent Skill, you will be using the [Moxie Eliza Skills Framework](https://github.com/moxie-protocol/moxie-agent-skills) as the base for your development.

In this tutorial, you will learn how to create your first Moxie Skill for your AI Agent using the [Moxie Eliza Skills Framework](https://github.com/moxie-protocol/moxie-agent-skills).
...
Once your environment is set up, fork [**the Moxie Eliza Skills Framework repository**](https://github.com/moxie-protocol/moxie-agent-plugin?tab=readme-ov-file#register-your-skills-to-moxie) and then clone it locally to your machine.
