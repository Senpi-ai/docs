...
To access the agent wallet instance, you can simply use the `agentWallet` state in your skill that is injected by the [Moxie Client](./03-moxie-client.mdx) as shown below:
