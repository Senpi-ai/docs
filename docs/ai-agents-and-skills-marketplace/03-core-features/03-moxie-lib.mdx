---
description: Moxie Libs provides a suite of functions that enables developers to execute on-chain transactions and retrieve Moxie-related data efficiently.
---
