...
In this tutorial, you will learn how to get hourly snapshots of a certain fan token by calling the Moxie Protocol Subgraph API.
...
Then, you can get the hourly snapshots of a certain fan token by calling the subgraph API with the following query:
