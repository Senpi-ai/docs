...
In this tutorial, you will learn how to get all the Moxie transfers from the vault contract of a certain fan token on the Moxie protocol by calling the Moxie Protocol Subgraph API.
...
Then, you can get all the Moxie transfers from the vault contract of a certain fan token on the Moxie protocol by calling the subgraph API with the following query:
