...
Once you created a new folder that will contain the code for your new Creator Agent skills, go to `packages/plugin-first-skill/package.json` to update the `name` and `version` of the Skills:
...
Next, you can proceed to [connect your skills to Moxie](./02-connect-skills-to-moxie.mdx) and offer your skills in the Moxie Creator Agent ecosystem.
