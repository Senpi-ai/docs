...
Once your environment is set up, fork [**the Senpi Eliza Skills Framework repository**](https://github.com/moxie-protocol/moxie-agent-plugin?tab=readme-ov-file#register-your-skills-to-moxie) and then clone it locally to your machine.
