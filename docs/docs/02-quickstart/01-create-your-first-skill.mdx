...
In this tutorial, you will learn how to create your first Moxie Skill for your AI Agent using the [Senpi Eliza Skills Framework](https://github.com/moxie-protocol/moxie-agent-skills).
