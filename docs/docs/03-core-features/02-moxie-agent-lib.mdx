---
description: Senpi Agent Libs provides a suite of functions that enables developers to execute on-chain transactions and retrieve Moxie-related data efficiently.
---
...
Senpi Agent Libs provides a suite of functions that enables developers to execute on-chain transactions and retrieve Moxie-related data efficiently.
...
These features make Senpi Agent Libs an essential toolkit for building AI Agent Skills for the Moxie Skills Marketplace.
