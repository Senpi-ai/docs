---
description: Learn how to get a certain user's estimated Based Rewards to earn today from the Dune table.
---

# Get User Estimated Based Rewards

Simply fork [this Dune table](https://dune.com/queries/4488299). Then, delete the existing query and replace with the following query below and `<moxie-user-id>` added as the desired user to search:
