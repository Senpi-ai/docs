...
Simply fork [this Dune table](https://dune.com/queries/4488208). Then, delete the existing query and replace with the following query below and `<moxie-user-id>` added as the desired user to search:
