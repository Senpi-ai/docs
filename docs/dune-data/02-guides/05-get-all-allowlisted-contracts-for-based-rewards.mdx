...
Keep in mind that the multiplier effect will only affect transactions to the allowlisted contract directly. Any non-direct transactions, that is transaction to Moxie bonding curve or staking contract that goes through a proxy contract, will not count.
