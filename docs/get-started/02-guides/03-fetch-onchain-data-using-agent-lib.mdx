...
To learn all the functions available in the Senpi Agent Lib, please refer to the [Senpi Agent Lib References](../../references/moxie-agent-lib/02-moxie-agent-lib.mdx).
