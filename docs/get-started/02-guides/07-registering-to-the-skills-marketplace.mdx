...
1. Adjust your AI Agent Skills metadata in the Skills Registry in `registry/src/skills.json` with the values and configurations you want to display in the Skills Marketplace.
