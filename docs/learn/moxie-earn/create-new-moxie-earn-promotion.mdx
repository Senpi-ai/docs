---
description: "Learn how to create a new promotion from the Moxie mini-app."
---
...
To create a new campaign, you will need to define the **target audience** you're looking to reach and the **engagement rewards boost** you are willing to provide for users quote casting the promoted cast.
...
Minimum amount to spend for each campaign will be 50,000 Moxie Token.
