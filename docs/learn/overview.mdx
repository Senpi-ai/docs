...
1. [**Build**](../ai-agents-and-skills-marketplace/02-quickstart/01-create-your-first-skill.mdx) your skill, using Eliza plugins
2. [**Connect**](../ai-agents-and-skills-marketplace/02-quickstart/02-connect-skills-to-moxie.mdx) your skills to Moxie – access user data, offer your skill in the Moxie AI Agent ecosystem
3. [**Transact**](../ai-agents-and-skills-marketplace/02-quickstart/03-execute-transactions-in-skill.mdx) – access the user's embedded wallet and write onchain transactions
4. [**Tokenize**](../ai-agents-and-skills-marketplace/02-quickstart/04-tokenize-your-skill.mdx) - every skill gets a token, enabling devs to monetize and grow
