...
$$
P = \sum_{i=1}^3 B_{usage}(U_i) = 52.89
$$
...
| User  | % Contribution                       |
| ----- | ------------------------------------ |
| $U_1$ | $4.87\% = \frac{B_{usage}(U_1)}{P}$  |
| $U_2$ | $36.66\% = \frac{B_{usage}(U_2)}{P}$ |
| $U_3$ | $58.47\% = \frac{B_{usage}(U_3)}{P}$ |

Finally, the total 5,000 Moxie will be distributed to each user as Based Rewards based on their % contribution to the pool:

| User  | Based Rewards                     |
| ----- | --------------------------------- |
| $U_1$ | $243.62 = 4.87\% \times 5,000$    |
| $U_2$ | $1,832.78 = 36.66\% \times 5,000$ |
| $U_3$ | $2,923.60 = 58.47\% \times 5,000$ |
