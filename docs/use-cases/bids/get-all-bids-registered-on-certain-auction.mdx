...
sidebar_position: 1
description: Learn how to use the Moxie Auction Subgraph API to get all the bids registered on a certain auction.
---
...
<Header
  useCase="get all bids, regardless of status (e.g. created, cancelled, claimed), on a certain auction"
...
<AddQuery
  useCase="get all bids registered on a certain auction"
...
<ExecuteCode
  ...
  dataFetched="all the bids registered on a certain auction"
/>
