...
description: Learn how to use the Moxie Auction Subgraph API to get all fan token auctions created.
---
...
<Header
  useCase="get all fan token auctions created"
...
<ExecuteCode
  ...
  dataFetched="all fan token auctions on the Moxie protocol"
/>
