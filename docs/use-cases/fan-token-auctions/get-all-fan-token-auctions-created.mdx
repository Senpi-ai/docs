...
description: Learn how to use the Moxie Auction Subgraph API to get all Creator Coin auctions created.
---
...
# Get All Creator Coin Auctions Created

<Header
  useCase="get all Creator Coin auctions created"
...
<ExecuteCode
  ...
  dataFetched="all Creator Coin auctions on the Moxie protocol"
/>
