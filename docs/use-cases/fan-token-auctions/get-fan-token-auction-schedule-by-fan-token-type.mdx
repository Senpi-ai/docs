...
description: Learn how to use the Airstack GraphQL API to get all the Creator Coin auction schedules by the Creator Coin type.
---
...
# Get Creator Coin Auction Schedule By Creator Coin Type

<Header
  useCase="all the Creator Coin auction schedules by the Creator Coin type"
...
<AddQuery
  useCase="all the Creator Coin auction schedules by their status"
  ...
  variable={`{
  // For example, to fetch all auction schedules for channel-type Creator Coins
...
<ExecuteCode
  ...
  dataFetched="all the Creator Coin auction schedules by the Creator Coin type"
/>
