...
description: Learn how to use the Airstack GraphQL API to get all the Creator Coin auction schedules by their status.
---
...
# Get Creator Coin Auction Schedule By Status
...
<AddQuery
  ...
  variable={`{
  // For example, to fetch all upcoming Creator Coin auctions
  "status": "UPCOMING"
}`}
  response={`{
  "data": {
...
<ExecuteCode
  ...
  dataFetched="all the Creator Coin auction schedules by their status"
/>
