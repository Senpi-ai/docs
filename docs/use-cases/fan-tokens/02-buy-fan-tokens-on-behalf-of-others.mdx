...
Lastly, call the `buySharesForV2` function on the Moxie bonding curve contract to execute the Fan Token purchase transaction:
...
Congrats! 🥳🎉 You've just successfully purchased Fan Token for a third-party address on Base!
