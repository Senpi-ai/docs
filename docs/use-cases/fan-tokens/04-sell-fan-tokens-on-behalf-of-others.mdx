...
Lastly, call the `sellSharesForV2` function on the Moxie bonding curve contract to execute the Fan Token selling transaction:
...
Congrats! 🥳🎉 You've just successfully sold a Fan Token and transfer it to a third-party address!
