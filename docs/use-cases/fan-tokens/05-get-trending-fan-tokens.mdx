...
description: Learn how to use the Moxie Protocol Subgraph API to get the all-time trending Creator Coins sorted by the number of Creator Coin buy volume.
---
...
<Header
  useCase="get all-time trending Creator Coins sorted by the number of Creator Coin buy volume"
...
<ExecuteCode
  ...
  dataFetched="all-time trending Creator Coins on the Moxie protocol"
/>
