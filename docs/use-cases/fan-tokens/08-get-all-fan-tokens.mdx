...
description: Learn how to use the Moxie Protocol Subgraph API to get all the fan tokens in the Moxie protocol.
---
...
<Header
  useCase="get all the fan tokens in the Moxie protocol"
...
<ExecuteCode
  ...
  dataFetched="all the fan tokens in the Moxie protocol"
/>
