...
description: Learn how to use the Moxie Protocol Subgraph API to get all the holders snapshot of a certain Creator Coin.
---
...
# Get Holders Snapshot Of Certain Creator Coin

<Header
  useCase="get all the holders snapshot of a certain Creator Coin"
...
<ExecuteCode
  ...
  dataFetched="all the holders snapshot of a certain Creator Coin"
/>
