...
description: Learn how to use the Moxie Protocol Subgraph API to get all the member-type Creator Coins in the Moxie protocol.
---
...
# Get All Member Creator Coins

<Header
  useCase="get all the member-type Creator Coins in the Moxie protocol"
...
<ExecuteCode
  ...
  dataFetched="all the member-type Creator Coins in the Moxie protocol"
/>
