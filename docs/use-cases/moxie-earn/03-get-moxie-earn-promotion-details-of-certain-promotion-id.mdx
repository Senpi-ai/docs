...
description: "Learn how to fetch the Moxie Earn promotions details of a certain promotion ID."
---
...
<Header
  useCase="get Moxie Earn promotion details of a certain promotion ID"
...
<AddQuery
  ...
  query={`query Query($status: [PromotionStatus!], $promoterFid: String) {
