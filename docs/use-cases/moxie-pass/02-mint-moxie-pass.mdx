...
description: Learn how to use the Moxie Pass Mint API to mint Moxie Pass to a user.
---
...
<Header useCase="mint Moxie Pass to a user wallet" apiName="Moxie Pass Mint" />
