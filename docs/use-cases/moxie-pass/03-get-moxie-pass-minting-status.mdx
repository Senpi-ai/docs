...
description: Learn how to use the Moxie Partner API to get the Moxie Pass minting status after mint has been initiated.
---
...
<Header useCase="get Moxie Pass mint status" apiName="Moxie Partner" />
