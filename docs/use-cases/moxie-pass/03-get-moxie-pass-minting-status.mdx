...
description: Learn how to use the Moxie Pass Claim API to get the Moxie Pass minting status after mint has been initiated.
---
...
<Header useCase="get Moxie Pass mint status" apiName="Moxie Pass Claim" />
