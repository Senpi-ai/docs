...
description: Learn how to use the Moxie Protocol Subgraph API to get all the Moxie deposits to the vault contract by a certain Creator Coin on the Moxie protocol.
---
...
# Get Deposits To Vault Of Certain Creator Coin

<Header
  useCase="get all the Moxie deposits to the vault contract by a certain Creator Coin"
...
<ExecuteCode
  ...
  dataFetched="all the Moxie deposits to the vault contract by a certain Creator Coin"
/>
