---
description: agentWallet state returns all Moxie agent's embedded wallet related information, from agent ID, address, etc.
---
...
`agentWallet` state returns all Moxie agent's embedded wallet related information, from agent ID, address, etc.
