...
const AddMutation = (props) => {
  ...
  return (
    <>
      <p>To {useCase}, you can use the following mutation:</p>
      <Tabs>
      ...
      With this GraphQL mutation, you can add it to your source code and call
      the API with the <code>graphql-request</code> library:
      <Tabs>
